      ...
      >
        ...
        <div className="composer-input-row">
          ...
          <textarea
            ...
            placeholder={
              disabled
                ? t("composer.input.disabled")
                : t("composer.input.placeholder")
            }
            value={text}
          ...
          <div className="composer-input-actions">
            {onToggleExpand && (
              <button
                ...
                disabled={disabled}
                aria-label={isExpanded ? t("composer.collapse") : t("composer.expand")}
                title={isExpanded ? t("composer.collapse") : t("composer.expand")}
              >
